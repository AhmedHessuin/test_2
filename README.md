...
---
# solution
* update all files used in [east](http://arwash.rdi:5050/ocr/research/EAST/-/blob/master/readme.md) to work with tf v2.3.0
...
* cuda 10.1
* cython
* build [geo_mab builde.sh](http://arwash.rdi:5050/ocr/research/table_detection_formation/-/blob/master/tensorflow%202.3.0%20east/scripts/geo_map_cython_lib/build_ext.sh)
--- 
# enviroment setup 
